...
class ChurchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create church" do
    assert_difference('Church.count') do
      post churches_url, params: { church: { location: @church.location, motto: @church.motto, name: @church.name, photo: @church.photo, trash: @church.trash } }, as: :json
    end
  ...
  test "should update church" do
    patch church_url(@church), params: { church: { location: @church.location, motto: @church.motto, name: @church.name, photo: @church.photo, trash: @church.trash } }, as: :json
    assert_response 200
  end
